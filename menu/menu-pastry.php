    ...
    <header class="bg-medcream py-5">
      <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
          <h1 class="display-4 fw-bolder">Pastry</h1>
          </p>
        </div>
      </div>
    </header>
            ...
            <div class="card h-100">
              ...
              <div class="card-body p-4">
                <div class="text-center">
                  <!-- Product name-->
                  <h5 class="fw-bolder">Bagelan Manis</h5>
                  <!-- Product price-->
                  Rp. 40.000
                </div>
              </div>
          ...
          <div class="col mb-5">
            <div class="card h-100">
              ...
              <div class="card-body p-4">
                <div class="text-center">
                  <!-- Product name-->
                  <h5 class="fw-bolder">Bagelan Garlic</h5>
                  <!-- Product price-->
                  Rp. 40.000
                </div>
              </div>
          ...
          <div class="col mb-5">
            <div class="card h-100">
              ...
              <div class="card-body p-4">
                <div class="text-center">
                  <!-- Product name-->
                  <h5 class="fw-bolder">Pisang Bolen Special</h5>
                  <!-- Product price-->
                  Rp. 45.000
                </div>
              </div>
